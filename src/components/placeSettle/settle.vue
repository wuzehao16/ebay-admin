          ...
          <el-row type="flex" class="row-bg" justify="center" :gutter='20'>
            <el-col :span='8'>
              <el-form-item label='一级客户'>
                <el-input v-model="orderInfo.fir_level_name" placeholder="一级客户" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span='8'>
              <el-form-item label='一级提成比例'>
                <el-input v-model="orderInfo.fir_level_per" placeholder="一级提成比例" disabled></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row type="flex" class="row-bg" justify="center" :gutter='20'>
            <el-col :span='8'>
              <el-form-item label='二级客户'>
                <el-input v-model="orderInfo.sec_level_name" placeholder="二级客户" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span='8'>
              <el-form-item label='二级比例提成'>
                <el-input v-model="orderInfo.sec_level_per" placeholder="二级比例提成" disabled></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row type="flex" class="row-bg" justify="center" :gutter='20'>
          ...
          <el-row type="flex" class="row-bg" justify="center" :gutter='20'>
            <el-col :span='16'>
              <el-form-item label='审核结论'>
                <el-radio-group v-model='orderInfo.audit_conclusion'>
            ...
            <el-col :span='16'>
              <el-form-item label='审核意见'>
				<el-input type="textarea" :autosize="{ minRows: 3, maxRows: 6}" placeholder="请输入内容"
				  v-model="orderInfo.audit_opinion">
				</el-input>
              </el-form-item>
            </el-col>
          </el-row>                  
...
<script>
import { reqGetPlaceSettle } from '../../api/api';
...
export default {
  ...
  methods: {
    ...
    editSubmit() {
    	reqGetPlaceSettle(this.orderInfo).then((res) => {
            this.$message({
              message: '提交成功',
              type: 'success'
            });
